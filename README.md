...
- /main - Показать главную страницу
- /profile - Показать профиль пользователя
- /lists - Показать списки пользователя
- /lists/[id] - Показать список с id
- /wishes/[id] - Показать желание с id
- /users/[id] - Показать пользователя c id
