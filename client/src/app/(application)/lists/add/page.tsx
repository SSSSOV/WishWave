...
import { handleAddWishList } from "@/context/wish_lists";
...
export default function AddListPage() {
  ...
  // Стор
  const [addWishList] = useUnit([handleAddWishList]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      addWishList({ name: name, eventDate: date, description: desc, accesslevelId: access });
      router.back();
    } catch (error) {
      console.log(error);
    }
